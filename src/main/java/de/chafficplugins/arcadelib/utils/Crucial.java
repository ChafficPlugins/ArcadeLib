...
import static de.chafficplugins.arcadelib.utils.ConfigStrings.CRUCIAL_API_VERSION;

public class Crucial {
    private static final ArcadeLib plugin = ArcadeLib.getPlugin(ArcadeLib.class);
